...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Z0D3[0x6];                                   // 0x0032(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_W83J[0x3];                                   // 0x0079(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void AddDifficultyParams(TArray<struct FAnalyticsEventAttr> EventAttrIn, const struct FRadiusGameDifficulty& GameDifficulty, TArray<struct FAnalyticsEventAttr>* EventAttrOut);
