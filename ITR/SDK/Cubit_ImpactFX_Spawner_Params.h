...
namespace CG
{
	 ...
	 */
	struct ACubit_ImpactFX_Spawner_C_GetFXType_Params
	{	};
	 ...
	 */
	struct ACubit_ImpactFX_Spawner_C_SizzleLiquidFX_Params
	{	};
	 ...
	 */
	struct ACubit_ImpactFX_Spawner_C_DebrisFXSpawn_Params
	{	};

	/**
	 * Function Cubit_ImpactFX_Spawner.Cubit_ImpactFX_Spawner_C.Sizzle Dry FX
	 */
	struct ACubit_ImpactFX_Spawner_C_SizzleDryFX_Params
	{	};

	/**
	 * Function Cubit_ImpactFX_Spawner.Cubit_ImpactFX_Spawner_C.FX Type Chosen
	 */
	struct ACubit_ImpactFX_Spawner_C_FXTypeChosen_Params
	{	};
	 ...
	 */
	struct ACubit_ImpactFX_Spawner_C_PenetrationEvent_Params
	{	};
