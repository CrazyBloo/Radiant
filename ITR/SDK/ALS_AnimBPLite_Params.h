...
namespace CG
{
	 ...
	 */
	struct UALS_AnimBPLite_C_FootIK_Params
	{
	public:
	 ...
	 */
	struct UALS_AnimBPLite_C_CLFCycleBlending_Params
	{
	public:
		...
		struct FPoseLink                                           CLFCycleBlending;                                        // 0x0060(0x0010)  (Parm, OutParm, NoDestructor)
	};

	/**
	 * Function ALS_AnimBPLite.ALS_AnimBPLite_C.(N) CycleBlending
	 */
	struct UALS_AnimBPLite_C_NCycleBlending_Params
	{
	public:
		struct FPoseLink                                           F;                                                       // 0x0000(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
		struct FPoseLink                                           B;                                                       // 0x0010(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
		...
		struct FPoseLink                                           NCycleBlending;                                          // 0x0070(0x0010)  (Parm, OutParm, NoDestructor)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_NESD[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		float                                                      FRThreshold;                                             // 0x0004(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		float                                                      FLThreshold;                                             // 0x0008(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		float                                                      BRThreshold;                                             // 0x000C(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		float                                                      BLThreshold;                                             // 0x0010(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	public:
		...
		unsigned char                                              UnknownData_AV1L[0x6];                                   // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_IO94[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_YNRZ[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		bool                                                       ReturnValue;                                             // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_00NP[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_UKGB[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_BZKL[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct UALS_AnimBPLite_C_AnimNotify_CLFStop_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_8TIE[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UALS_AnimBPLite_C_AnimNotify_Pistol2HReadyRelaxed_Params
	{	};

	/**
	 * Function ALS_AnimBPLite.ALS_AnimBPLite_C.AnimNotify_Pistol 2H Relaxed->Ready
	 */
	struct UALS_AnimBPLite_C_AnimNotify_Pistol2HRelaxedReady_Params
	{	};
