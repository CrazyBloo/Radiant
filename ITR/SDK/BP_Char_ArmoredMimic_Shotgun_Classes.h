...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Char_ArmoredMimic_Shotgun.BP_Char_ArmoredMimic_Shotgun_C
	 * Size -> 0x0013 (FullSize[0x0D40] - InheritedSize[0x0D2D])
	 */
	class ABP_Char_ArmoredMimic_Shotgun_C : public ABP_Char_Mimic_C
	{
	public:
		unsigned char                                              UnknownData_BMLM[0x3];                                   // 0x0D2D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_Char_ArmoredMimic_Shotgun(int32_t EntryPoint);
