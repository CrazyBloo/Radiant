...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_N07M[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BPC_Stock.BPC_Stock_C.ReceiveTick
	 */
	struct UBPC_Stock_C_ReceiveTick_Params
	{
	public:
	...
	/**
	 * Function BPC_Stock.BPC_Stock_C.CheckShouldClick
	 */
	struct UBPC_Stock_C_CheckShouldClick_Params
	{	};
