...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BPA_Item_Injector.BPA_Item_Injector_C.PlayFeedback
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class USkeletalMeshComponent*                      PlayerBodyRef                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		class FName                                        BoneName                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABPA_Item_Injector_C::PlayFeedback(class USkeletalMeshComponent* PlayerBodyRef, const class FName& BoneName)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPA_Item_Injector.BPA_Item_Injector_C.PlayFeedback");
		
		ABPA_Item_Injector_C_PlayFeedback_Params params {};
		params.PlayerBodyRef = PlayerBodyRef;
