...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function WBP_Element_RepairItem.WBP_Element_RepairItem_C.Update
	 */
	struct UWBP_Element_RepairItem_C_Update_Params
	{
	public:
		...
		unsigned char                                              UnknownData_QBYV[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
