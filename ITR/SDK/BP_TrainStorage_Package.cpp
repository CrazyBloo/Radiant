...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_TrainStorage.BP_TrainStorage_C.OnGamePaused
	 * 		Flags  -> ()
	 * Parameters:
	 * 		bool                                               bPaused                                                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABP_TrainStorage_C::OnGamePaused(bool bPaused)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_TrainStorage.BP_TrainStorage_C.OnGamePaused");
		
		ABP_TrainStorage_C_OnGamePaused_Params params {};
