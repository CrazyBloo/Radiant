...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6VVF[0x50];                                  // 0x02E8(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_L7TA[0x8];                                   // 0x04A8(0x0008) Fix Super Size
		unsigned char                                              UnknownData_XSB6[0x10];                                  // 0x04B0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HSQA[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZNJJ[0x44];                                  // 0x0054(0x0044) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RVLD[0x4];                                   // 0x00B0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YQZW[0x2];                                   // 0x00B6(0x0002) MISSED OFFSET (PADDING)
