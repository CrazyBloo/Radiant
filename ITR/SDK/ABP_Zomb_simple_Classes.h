...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_ZOJU[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_QXKK[0x2];                                   // 0x0F26(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
