...
namespace CG
{
	...
	{
	public:
		void IsMirrorHolsters(class UObject* __WorldContext, bool* Result);
		...
		void MatchesTagsArray(const struct FGameplayTag& tagOne, TArray<struct FGameplayTag>* otherTags, bool exactMatch, class UObject* __WorldContext, bool* Match, int32_t* ArrayIndex);
		...
		void Unlock(class AActor* Target, bool DenyGripping, class UObject* __WorldContext);
