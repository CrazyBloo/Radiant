...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Knife_4.BP_Knife_3_C.IsSmoothingScriptOn
	 */
	struct ABP_Knife_3_C_IsSmoothingScriptOn_Params
	{
	public:
	...
	/**
	 * Function BP_Knife_4.BP_Knife_3_C.GetSmoothingScript
	 */
	struct ABP_Knife_3_C_GetSmoothingScript_Params
	{
	public:
	 ...
	 */
	struct ABP_Knife_3_C_OffsetByPenetrationDepth_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_EDZG[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_SAWO[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Knife_4.BP_Knife_3_C.UpdateSmoothingAttachment
	 */
	struct ABP_Knife_3_C_UpdateSmoothingAttachment_Params
	{
	public:
		bool                                                       bUseLocalAlpha;                                          // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_OMR5[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Knife_4.BP_Knife_3_C.SmoothingToggle
	 */
	struct ABP_Knife_3_C_SmoothingToggle_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_R514[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_KQ8U[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FBPActorGripInformation                             GripInformation;                                         // 0x0010(0x01E0)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference)
	...
	public:
		...
		unsigned char                                              UnknownData_7I75[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
