...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Char_ArmoredMimic_SVD.BP_Char_ArmoredMimic_SVD_C
	 * Size -> 0x0013 (FullSize[0x0D40] - InheritedSize[0x0D2D])
	 */
	class ABP_Char_ArmoredMimic_SVD_C : public ABP_Char_Mimic_C
	{
	public:
		unsigned char                                              UnknownData_4WCE[0x3];                                   // 0x0D2D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_Char_ArmoredMimic_SVD(int32_t EntryPoint);
