...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Door.BP_Door_C.IsBroken
	 */
	struct ABP_Door_C_IsBroken_Params
	{
	public:
	...
	/**
	 * Function BP_Door.BP_Door_C.GetOpen
	 */
	struct ABP_Door_C_GetOpen_Params
	{
	public:
	...
	/**
	 * Function BP_Door.BP_Door_C.ParticleEffect_Dust
	 */
	struct ABP_Door_C_ParticleEffect_Dust_Params
	{	};

	/**
	 * Function BP_Door.BP_Door_C.DoCheck
	 */
	struct ABP_Door_C_DoCheck_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_V16I[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Door.BP_Door_C.OnGripRelease
	 */
	struct ABP_Door_C_OnGripRelease_Params
	{
	public:
		...
		unsigned char                                              UnknownData_UO9H[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Door.BP_Door_C.OnGrip
	 */
	struct ABP_Door_C_OnGrip_Params
	{
	public:
		...
		unsigned char                                              UnknownData_1YIS[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FBPActorGripInformation                             GripInformation;                                         // 0x0010(0x01E0)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference)
	};

	/**
	 * Function BP_Door.BP_Door_C.BndEvt__StaticMesh_K2Node_ComponentBoundEvent_1_ComponentWakeSignature__DelegateSignature
	 */
	struct ABP_Door_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_1_ComponentWakeSignature__DelegateSignature_Params
	{
	public:
	...
	/**
	 * Function BP_Door.BP_Door_C.CheckRotation
	 */
	struct ABP_Door_C_CheckRotation_Params
	{	};

	/**
	 * Function BP_Door.BP_Door_C.Initialize
	 */
	struct ABP_Door_C_Initialize_Params
	{	};

	/**
	 * Function BP_Door.BP_Door_C.BndEvt__StaticMesh_K2Node_ComponentBoundEvent_2_ComponentSleepSignature__DelegateSignature
	 */
	struct ABP_Door_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_2_ComponentSleepSignature__DelegateSignature_Params
	{
	public:
	...
	/**
	 * Function BP_Door.BP_Door_C.ReceiveEndPlay
	 */
	struct ABP_Door_C_ReceiveEndPlay_Params
	{
	public:
