...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_TutorMCPage_Main.WBP_TutorMCPage_Main_C
	 * Size -> 0x0048 (FullSize[0x02C0] - InheritedSize[0x0278])
	 */
	class UWBP_TutorMCPage_Main_C : public UWBPA_Page_C
	{
	public:
	...
	public:
		...
		void BndEvt__Button_Maintenance_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature();
		void BndEvt__Button_Maintenance_K2Node_ComponentBoundEvent_5_OnButtonHoverEvent__DelegateSignature();
		...
		void SetMissionsEnabled(bool Enabled);
		void ExecuteUbergraph_WBP_TutorMCPage_Main(int32_t EntryPoint);
