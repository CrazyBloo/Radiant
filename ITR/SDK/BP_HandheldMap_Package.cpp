...
namespace CG
{
	 ...
	 */
	void ABP_HandheldMap_C::RequestRecoil(const struct FVector& Recoil)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HandheldMap.BP_HandheldMap_C.Request Recoil");
		
		ABP_HandheldMap_C_RequestRecoil_Params params {};
