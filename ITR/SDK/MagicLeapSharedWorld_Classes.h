...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7YZ7[0xA4];                                  // 0x038C(0x00A4) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_3D37[0x18];                                  // 0x05D0(0x0018) MISSED OFFSET (PADDING)
