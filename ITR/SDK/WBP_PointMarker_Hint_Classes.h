...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_PointMarker_Hint.WBP_PointMarker_Hint_C
	 * Size -> 0x0018 (FullSize[0x0280] - InheritedSize[0x0268])
	 */
	class UWBP_PointMarker_Hint_C : public UWBP_PointMarker_Mission_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_WBP_PointMarker_Hint(int32_t EntryPoint);
