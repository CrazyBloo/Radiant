...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BPA_GrenadeLauncher.BPA_GrenadeLauncher_C.IsSmoothingScriptOn
	 * 		Flags  -> ()
	 */
	bool ABPA_GrenadeLauncher_C::IsSmoothingScriptOn()
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPA_GrenadeLauncher.BPA_GrenadeLauncher_C.IsSmoothingScriptOn");
		
		ABPA_GrenadeLauncher_C_IsSmoothingScriptOn_Params params {};
