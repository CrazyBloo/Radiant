...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LPU2[0x4];                                   // 0x035C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UVJ7[0x3];                                   // 0x0369(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EB95[0x4];                                   // 0x0374(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FSM4[0x3];                                   // 0x03A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void SwitchTriggerHelp(bool bIsRightHand);
		void SetHoldingHand(bool bIsRight);
		void SetGuitarMode(bool bIsPickInHand, bool bIsPlayMode);
		...
		void HighlightTriggetSet(bool bFirstSet);
