...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_PPSH.BP_PPSH_C
	 * Size -> 0x002F (FullSize[0x0EC0] - InheritedSize[0x0E91])
	 */
	class ABP_PPSH_C : public ABP_MagFirearmItem_C
	{
	public:
		unsigned char                                              UnknownData_RP8A[0x7];                                   // 0x0E91(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UStaticMeshComponent*                                WPN_AKM_WPN_AKM_trigger;                                 // 0x0EB8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash

	public:
		void ReceiveBeginPlay();
		void SafetyVisual(EWeaponFireMode FireMode);
		void ExecuteUbergraph_BP_PPSH(int32_t EntryPoint);
