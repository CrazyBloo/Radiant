...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_JRV8[0x2];                                   // 0x023E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6F1V[0xF0];                                  // 0x02F0(0x00F0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_T5YQ[0x7];                                   // 0x0291(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CAXO[0x7];                                   // 0x0281(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*>    AllInfoActors;                                           // 0x0288(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_N1Q7[0x8];                                   // 0x02D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_GN42[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HBSX[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (PADDING)
