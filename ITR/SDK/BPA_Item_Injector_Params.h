...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BPA_Item_Injector.BPA_Item_Injector_C.PlayFeedback
	 */
	struct ABPA_Item_Injector_C_PlayFeedback_Params
	{
	public:
		class USkeletalMeshComponent*                              PlayerBodyRef;                                           // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	public:
		...
		unsigned char                                              UnknownData_VFID[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_01UF[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
