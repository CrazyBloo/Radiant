...
namespace CG
{
	 ...
	 * Size -> 0x0086 (FullSize[0x04BB] - InheritedSize[0x0435])
	 */
	class ABP_TutorStep_ItemEquipCheck_C : public ABPA_TutorStep_C
	{
	public:
		unsigned char                                              UnknownData_3YLW[0x3];                                   // 0x0435(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I4YU[0x5];                                   // 0x0453(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EF1W[0x1];                                   // 0x0473(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K6FO[0x2];                                   // 0x0482(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AB4Q[0x7];                                   // 0x04A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
