...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 */
	void UBPC_ProfilingComponent_C::TickCacheFrameValues()
	{
		...
		UBPC_ProfilingComponent_C_TickCacheFrameValues_Params params {};
	 ...
	 */
	void UBPC_ProfilingComponent_C::GetAvgFrameTimes(float* AvgFrameMs, float* AvgGameThTimeMs, float* AvgRenderThTimeMs, float* AvgGpuFrameTimeMs)
	{
		...
		UBPC_ProfilingComponent_C_GetAvgFrameTimes_Params params {};
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class UPRCheatManager*                             AsPRCheatManager                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		bool                                               bIsValid                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UBPC_ProfilingComponent_C::GetCheatManager(class UPRCheatManager** AsPRCheatManager, bool* bIsValid)
	{
		...
		if (AsPRCheatManager != nullptr)
			*AsPRCheatManager = params.AsPRCheatManager;
		if (bIsValid != nullptr)
	 ...
	 */
	void UBPC_ProfilingComponent_C::LaunchFlare(float TimeToShine, bool bSwitchFlashlight)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPC_ProfilingComponent.BPC_ProfilingComponent_C.Launch Flare");
		
		UBPC_ProfilingComponent_C_LaunchFlare_Params params {};
