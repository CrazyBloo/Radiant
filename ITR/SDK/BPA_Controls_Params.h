...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BPA_Controls.BPA_Controls_C.IsControlAllowed
	 */
	struct ABPA_Controls_C_IsControlAllowed_Params
	{
	public:
		EControlAction                                             ControlAction;                                           // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		bool                                                       bIsAllowed;                                              // 0x0001(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};

	/**
	 * Function BPA_Controls.BPA_Controls_C.AsString
	 */
	struct ABPA_Controls_C_AsString_Params
	{
	public:
	...
	/**
	 * Function BPA_Controls.BPA_Controls_C.BlockInput
	 */
	struct ABPA_Controls_C_BlockInput_Params
	{
	public:
		TArray<EControlAction>                                     Actions;                                                 // 0x0000(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
		bool                                                       bAllow;                                                  // 0x0010(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_PSX6[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct ABPA_Controls_C_GetDefaultHand_Params
	{
	public:
	 ...
	 */
	struct ABPA_Controls_C_GetFormattedButtonName_Params
	{
	public:
		...
		unsigned char                                              UnknownData_OG8O[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_UNKV[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct ABPA_Controls_C_RebindAxis_Params
	{
	public:
	...
	public:
		EControlAction                                             Action;                                                  // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_PT6K[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_BH5M[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
