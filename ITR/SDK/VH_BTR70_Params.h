...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7MHF[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_Z0UJ[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function VH_BTR70.VH_BTR70_C.Unstuck
	 */
	struct AVH_BTR70_C_Unstuck_Params
	{	};

	/**
	 * Function VH_BTR70.VH_BTR70_C.CheckStuck
	 */
	struct AVH_BTR70_C_CheckStuck_Params
	{
	public:
		bool                                                       bStuck;                                                  // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_GNJQ[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_LKZF[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function VH_BTR70.VH_BTR70_C.StuckCheckEvent
	 */
	struct AVH_BTR70_C_StuckCheckEvent_Params
	{	};

	/**
	 * Function VH_BTR70.VH_BTR70_C.ReceiveEndPlay
	 */
	struct AVH_BTR70_C_ReceiveEndPlay_Params
	{
	public:
