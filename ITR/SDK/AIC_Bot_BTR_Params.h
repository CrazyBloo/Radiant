...
namespace CG
{
	...
	/**
	 * Function AIC_Bot_BTR.AIC_Bot_BTR_C.Initialize
	 */
	struct AAIC_Bot_BTR_C_Initialize_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_9LRG[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
