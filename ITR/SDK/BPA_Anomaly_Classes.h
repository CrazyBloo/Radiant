...
namespace CG
{
	...
	public:
		...
		class UAudioComponent*                                     Audio_BPToDelete;                                        // 0x03E0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
