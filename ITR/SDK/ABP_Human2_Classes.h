...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_ML5K[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		bool                                                       EnableJump;                                              // 0x1380(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
