...
namespace CG
{
	 ...
	 */
	bool UBPC_AliveStats_C::IsCriticalHit(class UObject* HitComponent, const class FName& BoneName)
	{
	 ...
	 */
	void UBPC_AliveStats_C::ApplyDamage(float InputDamage, class AActor* causer, class AActor* Weapon, float* appliedDamage)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPC_AliveStats.BPC_AliveStats_C.Apply Damage");
		
		UBPC_AliveStats_C_ApplyDamage_Params params {};
