...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_QZAI[0x3];                                   // 0x0421(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UGripMotionControllerComponent*                      HoldingController;                                       // 0x0430(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void HandleNonplayerInteraction(class AActor* Actor);
