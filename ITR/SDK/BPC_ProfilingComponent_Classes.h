...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1D65[0x4];                                   // 0x00FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RIMS[0x4];                                   // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_W2UF[0x2];                                   // 0x0126(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_64IB[0x4];                                   // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FE9M[0x7];                                   // 0x0181(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LKUN[0x7];                                   // 0x01C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FGameplayTagContainer                               itemTags;                                                // 0x01C8(0x0020) Edit, BlueprintVisible, DisableEditOnInstance
		TArray<struct FGameplayTag>                                GameplayTags;                                            // 0x01E8(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		...
		unsigned char                                              UnknownData_FGFG[0x4];                                   // 0x01FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8ISA[0x7];                                   // 0x0271(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void TickCacheFrameValues();
		void GetAvgFrameTimes(float* AvgFrameMs, float* AvgGameThTimeMs, float* AvgRenderThTimeMs, float* AvgGpuFrameTimeMs);
		void StopCachingFPS();
		...
		void GetCheatManager(class UPRCheatManager** AsPRCheatManager, bool* bIsValid);
		void GetItemsNum(int32_t* ItemsNum);
		...
		void SwitchLights();
		void DEVPREP();
		void LaunchFlare(float TimeToShine, bool bSwitchFlashlight);
