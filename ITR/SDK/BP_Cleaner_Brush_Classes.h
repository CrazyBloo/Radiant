...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_VARO[0x1];                                   // 0x061B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class AActor*                                              HitActor;                                                // 0x0620(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
