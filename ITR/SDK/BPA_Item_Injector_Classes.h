...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0UAB[0x7];                                   // 0x0619(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void PlayFeedback(class USkeletalMeshComponent* PlayerBodyRef, const class FName& BoneName);
