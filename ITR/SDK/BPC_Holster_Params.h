...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KV4O[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UBPC_Holster_C_CheckifItemfromThisHolster_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_HSG0[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BPC_Holster.BPC_Holster_C.UpdatePhysicsCollision
	 */
	struct UBPC_Holster_C_UpdatePhysicsCollision_Params
	{	};
