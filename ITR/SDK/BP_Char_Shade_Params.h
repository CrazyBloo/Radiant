...
namespace CG
{
	 ...
	 */
	struct ABP_Char_Shade_C_FootstepsLoop__FinishedFunc_Params
	{	};

	/**
	 * Function BP_Char_Shade.BP_Char_Shade_C.Footsteps Loop__UpdateFunc
	 */
	struct ABP_Char_Shade_C_FootstepsLoop__UpdateFunc_Params
	{	};

	/**
	 * Function BP_Char_Shade.BP_Char_Shade_C.Footsteps Loop__Play Footstep__EventFunc
	 */
	struct ABP_Char_Shade_C_FootstepsLoop__PlayFootstep__EventFunc_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_1LSP[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
