...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function WBP_Page_UpgradeSelection.WBP_Page_UpgradeSelection_C.StateUpgrade
	 */
	struct UWBP_Page_UpgradeSelection_C_StateUpgrade_Params
	{
	public:
		bool                                                       Pause;                                                   // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_4USD[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_RPRF[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	/**
	 * Function WBP_Page_UpgradeSelection.WBP_Page_UpgradeSelection_C.StatUpgradeAnimation
	 */
	struct UWBP_Page_UpgradeSelection_C_StatUpgradeAnimation_Params
	{
	public:
		bool                                                       Pause;                                                   // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_STNL[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
