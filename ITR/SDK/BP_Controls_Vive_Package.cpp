...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_Controls_Vive.BP_Controls_Vive_C.IsAllowFirearmControl
	 * 		Flags  -> ()
	 * Parameters:
	 * 		bool                                               bIsAllowed                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABP_Controls_Vive_C::IsAllowFirearmControl(bool* bIsAllowed)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Controls_Vive.BP_Controls_Vive_C.IsAllowFirearmControl");
		
		ABP_Controls_Vive_C_IsAllowFirearmControl_Params params {};
