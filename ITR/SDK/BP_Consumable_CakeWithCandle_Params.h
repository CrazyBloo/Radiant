...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CP5G[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Consumable_CakeWithCandle.BP_Consumable_CakeWithCandle_C.RequestPhysicsCollision
	 */
	struct ABP_Consumable_CakeWithCandle_C_RequestPhysicsCollision_Params
	{
	public:
		bool                                                       On;                                                      // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_U88U[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Consumable_CakeWithCandle.BP_Consumable_CakeWithCandle_C.BlowOutCandle
	 */
	struct ABP_Consumable_CakeWithCandle_C_BlowOutCandle_Params
	{	};
