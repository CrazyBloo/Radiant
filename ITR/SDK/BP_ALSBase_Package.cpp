...
namespace CG
{
	 ...
	 */
	void ABP_ALSBase_C::FixDiagonalGamepadValues(float Yin, float Xin, float* YOut, float* XOut)
	{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FMantle_TraceSettings                       TraceSettings                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		EDrawDebugTrace                                    DebugType                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		bool                                               Vault                                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABP_ALSBase_C::MantleCheck(const struct FMantle_TraceSettings& TraceSettings, EDrawDebugTrace DebugType, bool* Vault)
	{
	 ...
	 */
	bool ABP_ALSBase_C::SetActorLocationAndRotationUpdateTarget(const struct FVector& NewLocation, const struct FRotator& NewRotation, bool bSweep, bool bTeleport, struct FHitResult* SweepHitResult)
	{
		...
		ABP_ALSBase_C_SetActorLocationAndRotationUpdateTarget_Params params {};
	 ...
	 * 		float                                              TargetInterpSpeedConst                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		float                                              ActorInterpSpeedSmooth                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_ALSBase_C::SmoothCharacterRotation(const struct FRotator& Target, float TargetInterpSpeedConst, float ActorInterpSpeedSmooth)
	{
		...
		params.TargetInterpSpeedConst = TargetInterpSpeedConst;
		params.ActorInterpSpeedSmooth = ActorInterpSpeedSmooth;
