...
namespace CG
{
	 ...
	 */
	void ABP_MagFirearmItem_C::RequestRecoil(const struct FVector& Recoil)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_MagFirearmItem.BP_MagFirearmItem_C.Request Recoil");
		
		ABP_MagFirearmItem_C_RequestRecoil_Params params {};
