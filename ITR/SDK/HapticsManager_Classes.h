...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_2CLN[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RZWO[0x6];                                   // 0x006A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_F353[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0R7X[0x90];                                  // 0x0280(0x0090) MISSED OFFSET (PADDING)
