...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BPA_GrenadeLauncher.BPA_GrenadeLauncher_C.IsSmoothingScriptOn
	 */
	struct ABPA_GrenadeLauncher_C_IsSmoothingScriptOn_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_F889[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
