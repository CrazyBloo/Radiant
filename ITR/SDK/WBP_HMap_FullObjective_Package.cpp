...
namespace CG
{
	 ...
	 */
	void UWBP_HMap_FullObjective_C::GetTakenPics(TArray<struct FGameplayTag>* pictures)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function WBP_HMap_FullObjective.WBP_HMap_FullObjective_C.Get Taken Pics");
		
		UWBP_HMap_FullObjective_C_GetTakenPics_Params params {};
