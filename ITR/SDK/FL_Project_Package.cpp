...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function FL_Project.FL_Project_C.IsMirrorHolsters
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class UObject*                                     __WorldContext                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		bool                                               Result                                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UFL_Project_C::IsMirrorHolsters(class UObject* __WorldContext, bool* Result)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function FL_Project.FL_Project_C.IsMirrorHolsters");
		
		UFL_Project_C_IsMirrorHolsters_Params params {};
	 ...
	 */
	void UFL_Project_C::MatchesTagsArray(const struct FGameplayTag& tagOne, TArray<struct FGameplayTag>* otherTags, bool exactMatch, class UObject* __WorldContext, bool* Match, int32_t* ArrayIndex)
	{
	 ...
	 * 		bool                                               DenyGripping                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		class UObject*                                     __WorldContext                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UFL_Project_C::Unlock(class AActor* Target, bool DenyGripping, class UObject* __WorldContext)
	{
		...
		params.DenyGripping = DenyGripping;
		params.__WorldContext = __WorldContext;
