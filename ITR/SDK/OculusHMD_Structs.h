...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Enum OculusHMD.EOculusXrApi
	 */
	enum class EOculusXrApi : uint8_t
	{
		LegacyOVRPlugin = 0,
		OVRPluginOpenXR = 1,
		NativeOpenXR    = 2,
	...
	/**
	 * Enum OculusHMD.EHandTrackingFrequency
	 */
	enum class EHandTrackingFrequency : uint8_t
	{
		LOW  = 0,
		HIGH = 1,
		MAX  = 2
	...
	/**
	 * Enum OculusHMD.EPassthroughLayerOrder
	 */
	enum class EPassthroughLayerOrder : uint8_t
	{
		PassthroughLayerOrder_Overlay  = 0,
		PassthroughLayerOrder_Underlay = 1,
		PassthroughLayerOrder_MAX      = 2
	};

	/**
	 * Enum OculusHMD.EColorMapType
	 */
	enum class EColorMapType : uint8_t
	{
		ColorMapType_None       = 0,
		ColorMapType_MonoToRgba = 1,
		ColorMapType_MAX        = 2
	};
	...
	public:
		...
		unsigned char                                              UnknownData_8LTU[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U687[0x8];                                   // 0x0058(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       bLerpToHeadsetLocal;                                     // 0x0081(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_B057[0x2];                                   // 0x0082(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                                      LerpToHeadsetLocalSpeed;                                 // 0x0084(0x0004) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_WGVL[0x18];                                  // 0x0088(0x0018) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_6P5N[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_CSZX[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
