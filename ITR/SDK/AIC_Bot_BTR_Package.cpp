...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function AIC_Bot_BTR.AIC_Bot_BTR_C.Initialize
	 * 		Flags  -> ()
	 */
	void AAIC_Bot_BTR_C::Initialize()
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function AIC_Bot_BTR.AIC_Bot_BTR_C.Initialize");
		
		AAIC_Bot_BTR_C_Initialize_Params params {};
