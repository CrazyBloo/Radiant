...
namespace CG
{
	 ...
	 */
	void UWBP_GuitarChordSet_C::SetGuitarMode(bool bIsPickInHand, bool bIsPlayMode)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function WBP_GuitarChordSet.WBP_GuitarChordSet_C.Set Guitar Mode");
		
		UWBP_GuitarChordSet_C_SetGuitarMode_Params params {};
