...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BPI_PlayerControls.BPI_PlayerControls_C.ToggleAimSmoothing
	 */
	struct UBPI_PlayerControls_C_ToggleAimSmoothing_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_8K9F[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_GYZJ[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
