...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UD38[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_CA6G[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	/**
	 * Function BP_PRPlayerController.BP_PRPlayerController_C.ToggleAimSmoothing
	 */
	struct ABP_PRPlayerController_C_ToggleAimSmoothing_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_REBD[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
