...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_G8ZA[0x8];                                   // 0x04A8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_P55X[0x6];                                   // 0x04B2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BJBI[0x4];                                   // 0x04FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
