...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_PointMarker_GatePosition.WBP_PointMarker_GatePosition_C
	 * Size -> 0x0018 (FullSize[0x0278] - InheritedSize[0x0260])
	 */
	class UWBP_PointMarker_GatePosition_C : public UUserWidget
	{
	public:
	...
	public:
		void Setup(const class FText& Text, float IconAngle, const struct FLinearColor& IconColor);
		void ExecuteUbergraph_WBP_PointMarker_GatePosition(int32_t EntryPoint);
