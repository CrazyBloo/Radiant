...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Q7OO[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct ABPA_Grenade_C_VisualRecoil__FinishedFunc_Params
	{	};

	/**
	 * Function BPA_Grenade.BPA_Grenade_C.Visual Recoil__UpdateFunc
	 */
	struct ABPA_Grenade_C_VisualRecoil__UpdateFunc_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_HILU[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct ABPA_Grenade_C_CheckSafety_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_4WE3[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_PWIA[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FBPActorGripInformation                             GripInformation;                                         // 0x0010(0x01E0)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference)
	...
	public:
		...
		unsigned char                                              UnknownData_5X9X[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_E4WJ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
