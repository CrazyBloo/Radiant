...
namespace CG
{
	 ...
	 * Size -> 0x002F (FullSize[0x0EC0] - InheritedSize[0x0E91])
	 */
	class ABP_Weapon_G17_C : public ABP_MagFirearmItem_C
	{
	public:
		unsigned char                                              UnknownData_KHS7[0x7];                                   // 0x0E91(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UBPC_AtSl_PistolOptics_C*                            BPC_AtSl_PistolOptics;                                   // 0x0EA0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
