...
namespace CG
{
	 ...
	 */
	struct ABPA_Attachment_C_MakeUngripable_Params
	{	};

	/**
	 * Function BPA_Attachment.BPA_Attachment_C.Make Gripable
	 */
	struct ABPA_Attachment_C_MakeGripable_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_1UUP[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_XRZI[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FBPActorGripInformation                             GripInformation;                                         // 0x0010(0x01E0)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_WENH[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
