...
namespace CG
{
	...
	public:
		...
		struct FUpgradeInfo                                        UpgradeInfo;                                             // 0x02A0(0x0230) Edit, BlueprintVisible, DisableEditOnInstance
		...
		unsigned char                                              UnknownData_NVSA[0x6];                                   // 0x04D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
