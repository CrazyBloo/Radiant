...
namespace CG
{
	 ...
	 */
	class ABP_AKM_C : public ABP_MagFirearmItem_C
	{
	public:
		unsigned char                                              UnknownData_32D5[0x7];                                   // 0x0E91(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0E98(0x0008) ZeroConstructor, Transient, DuplicateTransient
		class UStaticMeshComponent*                                SM_AK74_Base_02_sight;                                   // 0x0EA0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		class UBPC_AtSl_USSR_GP32_C*                               BPC_AtSl_USSR_GP32;                                      // 0x0EA8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		class UBPC_AtSl_Integrated_USSR_RifleSupressor_C*          BPC_AtSl_Integrated_USSR_RifleSupressor;                 // 0x0EB0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		class UStaticMeshComponent*                                WPN_AKM_WPN_AKM_rear_sight_leaf;                         // 0x0ED8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_BP_AKM(int32_t EntryPoint);
