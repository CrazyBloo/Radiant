...
namespace CG
{
	...
	{
	public:
		class FScriptMulticastDelegate                             OnLeaveBounds;                                           // 0x00E0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnReturnToBounds;                                        // 0x00F0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_9T4Q[0x8];                                   // 0x0100(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B34G[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WUV1[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
