...
namespace CG
{
	 ...
	 * Size -> 0x0128 (FullSize[0x0378] - InheritedSize[0x0250])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_2VJG[0x4];                                   // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WWC8[0x4];                                   // 0x02B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UFeedbackFile*                                       HapticsFeedback_Mirrored;                                // 0x0370(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void CalcDistance(class AActor* targetActor, bool* bInRange, float* Distance);
		void CheckifItemfromThisHolster(class UInventoryItem* Item, bool* Result);
