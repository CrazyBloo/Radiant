...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Mission_Artifact_8.BP_Mission_Artifact_7_C
	 * Size -> 0x0010 (FullSize[0x0678] - InheritedSize[0x0668])
	 */
	class ABP_Mission_Artifact_7_C : public ABPA_Artifact_C
	{
	public:
	...
	public:
		...
		void StopUse();
		void ExecuteUbergraph_BP_Mission_Artifact_8(int32_t EntryPoint);
