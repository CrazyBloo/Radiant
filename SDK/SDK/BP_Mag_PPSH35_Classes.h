...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Mag_PPSH35.BP_Mag_PPSH35_C
	 * Size -> 0x0028 (FullSize[0x06C0] - InheritedSize[0x0698])
	 */
	class ABP_Mag_PPSH35_C : public ABP_MagItem_C
	{
	public:
		class USceneComponent*                                     BulltePoint05;                                           // 0x0698(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
