...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0I3J[0x7];                                   // 0x06D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CVED[0x3];                                   // 0x06E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GZM6[0x10];                                  // 0x06F0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_E6Q0[0xA0];                                  // 0x0710(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_A8G4[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K7BC[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NK36[0x28];                                  // 0x0090(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MJ2U[0x8];                                   // 0x0438(0x0008) MISSED OFFSET (PADDING)
