...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_S9U9[0x2];                                   // 0x0632(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IA6G[0x4];                                   // 0x063C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_97OP[0x4];                                   // 0x0694(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DOXE[0x3];                                   // 0x06BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F9EN[0x2];                                   // 0x0766(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TVOT[0x8];                                   // 0x0778(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XQUD[0x6];                                   // 0x07B2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		float Get_Chord_Frequency();
		void CreateChordTimeMap();
		int32_t GetChordIDByName(const class FString& ChordName);
		void Update_Next_Play_Time_and_Chord_ID(float* TimeToNextChord, int32_t* ChordID);
		void Cycle_Increment_Int(int32_t MaxValue, int32_t* ValueToIncrement, bool* bNewCycle);
		void GetGuitarWidget(class UWBP_GuitarChordSet_C** AsWBP_Guitar_Chord_Set);
		...
		void Update_CUE_Chord(float Angle);
