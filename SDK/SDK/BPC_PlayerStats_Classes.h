...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RK1F[0x7];                                   // 0x0151(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P2QJ[0x3];                                   // 0x0169(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2MHO[0x1];                                   // 0x0173(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void BuffEnd();
		void BuffStart(float AmmountToBoost, float ActiveTime_Sec);
