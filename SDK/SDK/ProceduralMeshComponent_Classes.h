...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_L3F1[0x8];                                   // 0x04A8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_OPXO[0x6];                                   // 0x04B2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A4YU[0x4];                                   // 0x04FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
