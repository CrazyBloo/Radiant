...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_ZKUP[0x7];                                   // 0x0E89(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UBPC_AtSl_Integrated_USSR_RifleSupressor_C*          BPC_AtSl_Integrated_USSR_RifleSupressor;                 // 0x0EA0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		class UStaticMeshComponent*                                WPN_AKM_WPN_AKM_rear_sight_leaf;                         // 0x0EC8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
