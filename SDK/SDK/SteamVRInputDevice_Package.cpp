...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		ESteamVRInputDevice_EHand                          hand                                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 ...
	 */
	void USteamVRInputDeviceFunctionLibrary::GetFingerCurlsAndSplays(ESteamVRInputDevice_EHand hand, struct FSteamVRFingerCurls* FingerCurls, struct FSteamVRFingerSplays* FingerSplays, ESkeletalSummaryDataType SummaryDataType)
	{
