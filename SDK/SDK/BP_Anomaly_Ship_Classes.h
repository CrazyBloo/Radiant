...
namespace CG
{
	...
	public:
		...
		class ABP_Spline_Path_C*                                   Spline_Path;                                             // 0x0408(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash
