...
namespace CG
{
	 ...
	 */
	struct UBPC_GrippableAmmo_C_Update_Bullet_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_1TUS[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_4O4E[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
