...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_3WXI[0x7];                                   // 0x0B19(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_G44Y[0x7];                                   // 0x0B39(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UTimelineComponent*                                  Footsteps_Sprinting;                                     // 0x0B40(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_QPCX[0x7];                                   // 0x0B49(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UTimelineComponent*                                  Footsteps_RUnning;                                       // 0x0B50(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_7AZZ[0x7];                                   // 0x0B59(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UTimelineComponent*                                  Footsteps_Walking;                                       // 0x0B60(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_EL43[0x3];                                   // 0x0B6D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		EBotMovementMode                                           BotMovement_Mode;                                        // 0x0D2C(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void Footsteps_Walking__FinishedFunc();
		void Footsteps_Walking__UpdateFunc();
		void Footsteps_Walking__Play_footstep__EventFunc();
		void Footsteps_RUnning__FinishedFunc();
		void Footsteps_RUnning__UpdateFunc();
		void Footsteps_RUnning__Play_Footstep__EventFunc();
		void Footsteps_Sprinting__FinishedFunc();
		void Footsteps_Sprinting__UpdateFunc();
		void Footsteps_Sprinting__Play_Footstep__EventFunc();
		void OnStart();
