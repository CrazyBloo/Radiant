...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_X0OO[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x02C0(0x0008) ZeroConstructor, Transient, DuplicateTransient
		unsigned char                                              UnknownData_MN51[0x8];                                   // 0x02C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YOUT[0x2];                                   // 0x107CE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OY90[0x1];                                   // 0x107DB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZMCB[0x3];                                   // 0x10875(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4U4Y[0x4];                                   // 0x10884(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S57U[0x4];                                   // 0x1098C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void CLF_CycleBlending(const struct FPoseLink& F, const struct FPoseLink& B, const struct FPoseLink& LF, const struct FPoseLink& LB, const struct FPoseLink& RF, const struct FPoseLink& RB, struct FPoseLink* CLF_CycleBlending);
		void N_CycleBlending(const struct FPoseLink& F, const struct FPoseLink& B, const struct FPoseLink& LF, const struct FPoseLink& LB, const struct FPoseLink& RF, const struct FPoseLink& RB, const struct FPoseLink& Sprint, struct FPoseLink* N_CycleBlending);
		...
		void AnimNotify__CLF_Stop();
		void AnimNotify_StopTransition();
		void PlayTransition(const struct FDynamicMontageParams& Parameters);
		void AnimNotify_Roll_Idle();
		void AnimNotify__N_Stop_L();
		void AnimNotify__N_Stop_R();
		void AnimNotify_Land_Idle();
		void AnimNotify__N_QuickStop();
		void AnimNotify_Reset_GroundedEntryState();
		void AnimNotify_Bow_Ready_Relaxed();
		void AnimNotify_Bow_Relaxed_Ready();
		void AnimNotify_M4A1_Ready_Relaxed();
		void AnimNotify_M4A1_Relaxed_Ready();
		void AnimNotify_Pistol_1H_Ready_Relaxed();
		void AnimNotify_Pistol_1H_Relaxed_Ready();
		...
		void AnimNotify_Pistol_2H_Ready_Relaxed();
		void AnimNotify_Pistol_2H_Relaxed_Ready();
		void OnJumped();
