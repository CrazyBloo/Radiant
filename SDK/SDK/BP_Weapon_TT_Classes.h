...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Weapon_TT.BP_Weapon_TT_C
	 * Size -> 0x002F (FullSize[0x0EB8] - InheritedSize[0x0E89])
	 */
	class ABP_Weapon_TT_C : public ABP_MagFirearmItem_C
	{
	public:
		unsigned char                                              UnknownData_GS5K[0x7];                                   // 0x0E89(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
