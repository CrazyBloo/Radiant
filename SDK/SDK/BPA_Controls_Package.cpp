...
namespace CG
{
	 ...
	 */
	void ABPA_Controls_C::Get_Default_Hand(EControlAction Action, EHand_EHand DefaultHand, EHand_EHand* hand)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPA_Controls.BPA_Controls_C.Get Default Hand");
		
		ABPA_Controls_C_Get_Default_Hand_Params params {};
	 ...
	 */
	void ABPA_Controls_C::Get_Formatted_Button_Name(class UDataTable* DataTable, EControlAction Action, class FString* Name, EHand_EHand* hand, class UTexture2D** HelpImage)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPA_Controls.BPA_Controls_C.Get Formatted Button Name");
		
		ABPA_Controls_C_Get_Formatted_Button_Name_Params params {};
	 ...
	 */
	void ABPA_Controls_C::Rebind_Axis(const class FName& AxisName, const struct FKey& NewKey)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPA_Controls.BPA_Controls_C.Rebind Axis");
		
		ABPA_Controls_C_Rebind_Axis_Params params {};
