...
namespace CG
{
	 ...
	 */
	struct ABP_Char_Fracture_C_Footsteps_Loop__FinishedFunc_Params
	{	};

	/**
	 * Function BP_Char_Fracture.BP_Char_Fracture_C.Footsteps Loop__UpdateFunc
	 */
	struct ABP_Char_Fracture_C_Footsteps_Loop__UpdateFunc_Params
	{	};

	/**
	 * Function BP_Char_Fracture.BP_Char_Fracture_C.Footsteps Loop__Play Footstep__EventFunc
	 */
	struct ABP_Char_Fracture_C_Footsteps_Loop__Play_Footstep__EventFunc_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_ENSR[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_N4XQ[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		float                                                      Damage;                                                  // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_QWTO[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		class UDamageType*                                         DamageType;                                              // 0x0008(0x0008)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	public:
		...
		unsigned char                                              UnknownData_Y4CS[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
