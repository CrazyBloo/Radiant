...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_ActorMark.WBP_ActorMark_C
	 * Size -> 0x0018 (FullSize[0x0278] - InheritedSize[0x0260])
	 */
	class UWBP_ActorMark_C : public UUserWidget
	{
	public:
	...
	public:
		void Construct();
		void ExecuteUbergraph_WBP_ActorMark(int32_t EntryPoint);
