...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LLL5[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BPA_Scope.BPA_Scope_C.AttachTo
	 */
	struct ABPA_Scope_C_AttachTo_Params
	{
	public:
