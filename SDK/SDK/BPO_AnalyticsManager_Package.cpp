...
namespace CG
{
	 ...
	 * 		TArray<struct FAnalyticsEventAttr>                 EventAttrOut                                               (Parm, OutParm)
	 */
	void UBPO_AnalyticsManager_C::Add_Difficulty_Params(TArray<struct FAnalyticsEventAttr> EventAttrIn, const struct FRadiusGameDifficulty& GameDifficulty, TArray<struct FAnalyticsEventAttr>* EventAttrOut)
	{
		...
		UBPO_AnalyticsManager_C_Add_Difficulty_Params_Params params {};
		params.EventAttrIn = EventAttrIn;
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		bool                                               SkipTutor                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 ...
	 * 		struct FVector                                     DeathLocation                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	 ...
	 * 		struct FVector                                     DeathLocation                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UBPO_AnalyticsManager_C::OnPlayerKill(class AActor* KilledActor, const struct FGameplayTag& weaponTag, const struct FVector& DeathLocation)
	{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FGameplayTag                                TutorialId                                                 (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
	 * 		int32_t                                            TotalSteps                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		int32_t                                            CompletedSteps                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
