...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Consumable_Sweet.BP_Consumable_Sweet_C.OnGrip
	 */
	struct ABP_Consumable_Sweet_C_OnGrip_Params
	{
	public:
		...
		unsigned char                                              UnknownData_TRQD[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Consumable_Sweet.BP_Consumable_Sweet_C.OnGripRelease
	 */
	struct ABP_Consumable_Sweet_C_OnGripRelease_Params
	{
	public:
		...
		unsigned char                                              UnknownData_Z8ZK[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FBPActorGripInformation                             GripInformation;                                         // 0x0010(0x01E0)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference)
		bool                                                       bWasSocketed;                                            // 0x01F0(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};

	/**
	 * Function BP_Consumable_Sweet.BP_Consumable_Sweet_C.ExecuteUbergraph_BP_Consumable_Sweet
	 */
	struct ABP_Consumable_Sweet_C_ExecuteUbergraph_BP_Consumable_Sweet_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_N6VB[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
