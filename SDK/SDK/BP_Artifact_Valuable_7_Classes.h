...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Artifact_Valuable_7.BP_Artifact_Valuable_6_C
	 * Size -> 0x0010 (FullSize[0x0678] - InheritedSize[0x0668])
	 */
	class ABP_Artifact_Valuable_6_C : public ABPA_Artifact_C
	{
	public:
	...
	public:
		...
		void StopUse();
		void ExecuteUbergraph_BP_Artifact_Valuable_7(int32_t EntryPoint);
