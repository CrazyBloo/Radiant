...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_7Q5T[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AZS3[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_OCZ3[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KDMT[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZN8K[0x1];                                   // 0x04B3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PWNE[0x34];                                  // 0x04C8(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GPFX[0xF];                                   // 0x0501(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4QQU[0x2C];                                  // 0x002C(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_48LQ[0x24];                                  // 0x005C(0x0024) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6164[0x68];                                  // 0x0060(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CJYB[0xC];                                   // 0x00CC(0x000C) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BKIT[0xB0];                                  // 0x0058(0x00B0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1CEN[0xB0];                                  // 0x0058(0x00B0) MISSED OFFSET (PADDING)
