...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_QOAF[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct ABPA_Firearm_BoltAction_C_Grip_Unlock_Params
	{	};

	/**
	 * Function BPA_Firearm_BoltAction.BPA_Firearm_BoltAction_C.Grip Lock
	 */
	struct ABPA_Firearm_BoltAction_C_Grip_Lock_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_ASD4[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_IC5R[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FBPActorGripInformation                             GripInformation;                                         // 0x0010(0x01E0)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_JZTM[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_JO69[0xE];                                   // 0x0002(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
