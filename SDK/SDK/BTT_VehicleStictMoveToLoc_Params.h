...
namespace CG
{
	 ...
	 */
	struct UBTT_VehicleStictMoveToLoc_C_Event_Reverse_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_WY48[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
