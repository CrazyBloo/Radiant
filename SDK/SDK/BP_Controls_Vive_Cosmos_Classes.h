...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Controls_Vive_Cosmos.BP_Controls_Vive_Cosmos_C
	 * Size -> 0x0010 (FullSize[0x0314] - InheritedSize[0x0304])
	 */
	class ABP_Controls_Vive_Cosmos_C : public ABPA_Controls_C
	{
	public:
		unsigned char                                              UnknownData_KGZQ[0x4];                                   // 0x0304(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_Controls_Vive_Cosmos(int32_t EntryPoint);
