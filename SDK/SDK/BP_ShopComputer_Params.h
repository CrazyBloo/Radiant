...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_WA2V[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function BP_ShopComputer.BP_ShopComputer_C.Is Shop Bin Visible
	 */
	struct ABP_ShopComputer_C_Is_Shop_Bin_Visible_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_S9XU[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
