...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class ABP_PRPlayerController_C*                    PRPlayer_Controller                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		bool                                               bIsSuccess                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABP_Guitar_C::GetPRPlayerController(class ABP_PRPlayerController_C** PRPlayer_Controller, bool* bIsSuccess)
	{
		...
		if (PRPlayer_Controller != nullptr)
			*PRPlayer_Controller = params.PRPlayer_Controller;
	 ...
	 */
	void ABP_Guitar_C::Init_Other_Item_Pick(class AActor* ActorReference)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Guitar.BP_Guitar_C.Init Other Item Pick");
		
		ABP_Guitar_C_Init_Other_Item_Pick_Params params {};
	 ...
	 */
	void ABP_Guitar_C::On_Song_Changed(const class FName& SongID)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Guitar.BP_Guitar_C.On Song Changed");
		
		ABP_Guitar_C_On_Song_Changed_Params params {};
	 ...
	 */
	void ABP_Guitar_C::Update_Next_Play_Time_and_Chord_ID(float* TimeToNextChord, int32_t* ChordID)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Guitar.BP_Guitar_C.Update Next Play Time and Chord ID");
		
		ABP_Guitar_C_Update_Next_Play_Time_and_Chord_ID_Params params {};
	 ...
	 */
	void ABP_Guitar_C::Cycle_Increment_Int(int32_t MaxValue, int32_t* ValueToIncrement, bool* bNewCycle)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Guitar.BP_Guitar_C.Cycle Increment Int");
		
		ABP_Guitar_C_Cycle_Increment_Int_Params params {};
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class UWBP_GuitarChordSet_C*                       AsWBP_Guitar_Chord_Set                                     (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_Guitar_C::GetGuitarWidget(class UWBP_GuitarChordSet_C** AsWBP_Guitar_Chord_Set)
	{
		...
		if (AsWBP_Guitar_Chord_Set != nullptr)
			*AsWBP_Guitar_Chord_Set = params.AsWBP_Guitar_Chord_Set;
	}
