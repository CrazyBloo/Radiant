...
namespace CG
{
	 ...
	 * 		float                                              ActiveTime_Sec                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UBPC_PlayerStats_C::BuffStart(float AmmountToBoost, float ActiveTime_Sec)
	{
		...
		params.ActiveTime_Sec = ActiveTime_Sec;
