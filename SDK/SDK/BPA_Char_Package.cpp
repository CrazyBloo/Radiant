...
namespace CG
{
	 ...
	 */
	void ABPA_Char_C::Reappear_Cover_Callback(const struct FNpcPointQueryResult& QueryResult)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPA_Char.BPA_Char_C.Reappear Cover Callback");
		
		ABPA_Char_C_Reappear_Cover_Callback_Params params {};
