...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6CVL[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_HSMU[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		TArray<struct FVector>                                     Points;                                                  // 0x0008(0x0010)  (Parm, OutParm)
		TArray<class AActor*>                                      Actors;                                                  // 0x0018(0x0010)  (Parm, OutParm)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_ESV6[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
