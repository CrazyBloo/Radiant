...
namespace CG
{
	 ...
	 */
	void ABP_Map_Level_C::Remap_Location(const struct FVector& relativeRealLocation, struct FVector* relativeMapLocation)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Map_Level.BP_Map_Level_C.Remap Location");
		
		ABP_Map_Level_C_Remap_Location_Params params {};
