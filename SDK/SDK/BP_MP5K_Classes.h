...
namespace CG
{
	 ...
	 * Size -> 0x008F (FullSize[0x0F18] - InheritedSize[0x0E89])
	 */
	class ABP_MP5K_C : public ABP_MagFirearmItem_C
	{
	public:
		unsigned char                                              UnknownData_W6AQ[0x7];                                   // 0x0E89(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0E90(0x0008) ZeroConstructor, Transient, DuplicateTransient
		class UBPC_AtSl_Integrated_Pistol_Supressor_C*             BPC_AtSl_Integrated_Pistol_Supressor;                    // 0x0E98(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		class UVRSliderComponent*                                  VRSlider_stock;                                          // 0x0EB0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		struct FGameplayTag                                        SliderTagParent;                                         // 0x0EC0(0x0008) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
		TMap<struct FGameplayTag, float>                           SliderTagToValue;                                        // 0x0EC8(0x0050) Edit, BlueprintVisible, DisableEditOnInstance
