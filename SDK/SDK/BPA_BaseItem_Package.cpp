...
namespace CG
{
	 ...
	 */
	void ABPA_BaseItem_C::Request_Recoil(const struct FVector& Recoil)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPA_BaseItem.BPA_BaseItem_C.Request Recoil");
		
		ABPA_BaseItem_C_Request_Recoil_Params params {};
