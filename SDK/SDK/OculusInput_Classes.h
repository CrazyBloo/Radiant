...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6G70[0x4];                                   // 0x0834(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_L1VT[0x6];                                   // 0x0842(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NH6W[0x1F];                                  // 0x08B1(0x001F) MISSED OFFSET (PADDING)
