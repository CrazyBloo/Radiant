...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3USS[0x8];                                   // 0x0100(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VFA1[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4DTZ[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
