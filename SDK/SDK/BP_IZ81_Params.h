...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_IZ81.BP_IZ81_C.GetPoseShift
	 */
	struct ABP_IZ81_C_GetPoseShift_Params
	{
	public:
		...
		unsigned char                                              UnknownData_6KLQ[0xF];                                   // 0x0001(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
