...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TKCL[0x4];                                   // 0x02DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8IQI[0x1];                                   // 0x035B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Remap_Location(const struct FVector& relativeRealLocation, struct FVector* relativeMapLocation);
