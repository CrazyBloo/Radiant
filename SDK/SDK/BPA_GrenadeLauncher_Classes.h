...
namespace CG
{
	...
	public:
		...
		class USoundBase*                                          Ammo_Load_Sound;                                         // 0x0670(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
