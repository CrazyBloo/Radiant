...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class FName                                        Fire_Point_socket                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_FirearmItem_C::AttachFirePointToProxy(const class FName& Fire_Point_socket)
	{
		...
		params.Fire_Point_socket = Fire_Point_socket;
	 ...
	 */
	void ABP_FirearmItem_C::Next_Fire_Mode(bool* Changed, EWeaponFireMode* FireMode)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_FirearmItem.BP_FirearmItem_C.Next Fire Mode");
		
		ABP_FirearmItem_C_Next_Fire_Mode_Params params {};
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class UGS_Smoothing_C*                             Smoothing_Script                                           (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_FirearmItem_C::GetSmoothingScript(class UGS_Smoothing_C** Smoothing_Script)
	{
		...
		if (Smoothing_Script != nullptr)
			*Smoothing_Script = params.Smoothing_Script;
	}
	 ...
	 */
	void ABP_FirearmItem_C::Is_Attachment_Slot_Busy(EItemSlot socket, bool* busy)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_FirearmItem.BP_FirearmItem_C.Is Attachment Slot Busy");
		
		ABP_FirearmItem_C_Is_Attachment_Slot_Busy_Params params {};
	 ...
	 */
	void ABP_FirearmItem_C::SetAdditionalSmoothing(bool TurnOn, float Alpha)
	{
