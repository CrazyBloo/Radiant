...
namespace CG
{
	 ...
	 */
	void ABP_Backpack_Simple_C::Get_BP_Holder_Backpack(class ABP_Holder_BackPack_C** BP)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Backpack_Simple.BP_Backpack_Simple_C.Get BP Holder Backpack");
		
		ABP_Backpack_Simple_C_Get_BP_Holder_Backpack_Params params {};
	 ...
	 */
	void ABP_Backpack_Simple_C::Request_Recoil(const struct FVector& Recoil)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Backpack_Simple.BP_Backpack_Simple_C.Request Recoil");
		
		ABP_Backpack_Simple_C_Request_Recoil_Params params {};
