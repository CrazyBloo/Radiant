...
namespace CG
{
	 ...
	 */
	struct UBPC_ProfilingComponent_C_Tick_Cache_Frame_Values_Params
	{	};

	/**
	 * Function BPC_ProfilingComponent.BPC_ProfilingComponent_C.Get Avg Frame Times
	 */
	struct UBPC_ProfilingComponent_C_Get_Avg_Frame_Times_Params
	{
	public:
	...
	{
	public:
		class UPRCheatManager*                                     AsPRCheat_Manager;                                       // 0x0000(0x0008)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 ...
	 */
	struct UBPC_ProfilingComponent_C_Get_Items_Num_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_LWPJ[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UBPC_ProfilingComponent_C_Launch_Flare_Params
	{
	public:
