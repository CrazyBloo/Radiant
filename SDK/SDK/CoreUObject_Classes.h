...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_L5PT[0x78];                                  // 0x0028(0x0078) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NKBG[0x180];                                 // 0x00B0(0x0180) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_210E[0x48];                                  // 0x0028(0x0048) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_T206[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_P24L[0x10];                                  // 0x00B0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_Q7WWSZ2PD7[0x01];                                    // 0x00A7(0x0001) PRE-DEFINED PROPERTY
		...
		unsigned char                                              pad_CYA0Y2DSME[0x04];                                    // 0x00C4(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_77EB[0x10];                                  // 0x00E0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_576P[0x80];                                  // 0x0230(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4QCG[0xB8];                                  // 0x0028(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PZSC[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_I6Y8[0x1B8];                                 // 0x0230(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_B6OP[0xC8];                                  // 0x0028(0x00C8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LFNL[0x1B8];                                 // 0x00E0(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HJKE[0xA0];                                  // 0x0028(0x00A0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XPWK[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Q665[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_P5EB[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WG6S[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ABFA[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_U5LG[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_K4PZ[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ICVT[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GL90[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4OP7[0x28];                                  // 0x0070(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_K7WN[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_86EE[0x20];                                  // 0x0070(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6ERQ[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VFPR[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2YH6[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
