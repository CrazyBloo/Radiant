...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_H75U[0x8];                                   // 0x0890(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U7I5[0x2C];                                  // 0x08A4(0x002C) MISSED OFFSET (PADDING)
