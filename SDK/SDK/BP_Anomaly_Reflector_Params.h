...
namespace CG
{
	 ...
	 */
	struct ABP_Anomaly_Reflector_C_Handle_Nonplayer_Interaction_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_Q9J1[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_TAPZ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
