...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_IIRB[0x7];                                   // 0x02C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_W9S8[0x8];                                   // 0x02D8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0M28[0x3];                                   // 0x02CD(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2YSR[0x3];                                   // 0x02CD(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HAKT[0x50];                                  // 0x0038(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J98Z[0x38];                                  // 0x0090(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VA13[0x10];                                  // 0x00D8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9QWQ[0x20];                                  // 0x00F8(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YUBK[0x40];                                  // 0x0048(0x0040) MISSED OFFSET (PADDING)
