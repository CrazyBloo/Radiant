...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_PointMarker_Primary.WBP_PointMarker_Primary_C
	 * Size -> 0x0018 (FullSize[0x0280] - InheritedSize[0x0268])
	 */
	class UWBP_PointMarker_Primary_C : public UWBP_PointMarker_Mission_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_WBP_PointMarker_Primary(int32_t EntryPoint);
