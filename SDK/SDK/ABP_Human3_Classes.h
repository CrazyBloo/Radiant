...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_6EFP[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		bool                                                       Enable_Jump;                                             // 0x2508(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		...
		unsigned char                                              UnknownData_ICPT[0x3];                                   // 0x2515(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1T9U[0x7];                                   // 0x2529(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
